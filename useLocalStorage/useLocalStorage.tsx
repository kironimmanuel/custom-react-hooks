...
const getLocalStorageValue = <T,>(key: string, initialValue: InitialValueType<T>): T => {
...
export const useLocalStorage = <T,>(key: string, initialValue: InitialValueType<T>): [T, (value: T) => void] => {
